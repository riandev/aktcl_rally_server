...
client.connect((err) => {
  const userCollection = client.db("aktcl_rally").collection("users");
  const adminCollection = client.db("aktcl_rally").collection("admins");
  const leadsCollection = client.db("aktcl_rally").collection("leads");
  ...
  const tmsTmrCollection = client
    .db("aktcl_rally")
    .collection("tms_tmr_report");
